...
public class C03_WebElementMethodlari {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println(aramaKutusuElementi.getSize()); // (1762, 38)
        ...
        System.out.println(aramaKutusuElementi.getLocation()); // (305, 11)
        System.out.println(aramaKutusuElementi.getRect().getDimension()); // (1762, 38)
